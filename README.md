...
This course is aimed at anyone who wants to learn a simple but powerful modern programming language. The course leads students from the basics of writing and running Python scripts to more advanced features such as working with data, and using Python modules.
